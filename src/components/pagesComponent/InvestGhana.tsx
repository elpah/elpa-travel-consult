...
import { TrendingUp, MapPin, Sprout, Building, Factory, DollarSign, CheckCircle2, ArrowRight, Shield, Users, FileText, Globe } from 'lucide-react';
export const InvestGhana = () => {
  ...
  const benefits = ['Ghana ranked #1 for ease of doing business in West Africa', 'Stable democracy with investor-friendly policies', 'Growing economy with 6-7% annual GDP growth', 'English-speaking country with common law system', 'Gateway to West African market of 400+ million people', 'Foreign land ownership allowed in most regions', 'Tax incentives for investors in priority sectors', 'Strong agricultural sector with year-round production'];
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          y: 0
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8">
              ...
              From prime land to profitable farms, we guide your investment journey every step of the way.
            </p>
          </motion.div>
          <motion.div initial={{
          opacity: 0,
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="space-y-12">
            {investmentCategories.map((category, index) => <motion.div key={category.title} initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            delay: index * 0.1
                ...
                <div className="p-6">
                  <div className="grid md:grid-cols-2 gap-4">
                    {category.opportunities.map((opp, oppIndex) => <div key={oppIndex} className="border border-slate-200 rounded-xl p-5 hover:border-emerald-300 hover:shadow-md transition-all">
                        <h4 className="font-bold text-slate-900 mb-2">{opp.name}</h4>
                        <div className="space-y-1 text-sm text-slate-600">
                          <p><span className="font-semibold">Size:</span> {opp.size}</p>
                          <p><span className="font-semibold">Investment:</span> {opp.price}</p>
                          {opp.roi && <p className="text-emerald-600 font-semibold">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          y: 0
            ...
            <h2 className="text-4xl font-bold mb-4">
              Ready to Build Wealth in Ghana?
            </h2>
            <p className="text-xl mb-8 text-emerald-50">
              Schedule a free consultation to discuss your investment goals and explore opportunities
            </p>
