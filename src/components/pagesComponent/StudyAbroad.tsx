...
import { GraduationCap, MapPin, Star, BookOpen, FileText, CheckCircle2, Globe, Users, Award, TrendingUp } from 'lucide-react';
...
export const StudyAbroad = () => {
  const destinations = [{
    ...
    highlights: ['Top-ranked institutions', 'OPT work authorization', 'Scholarship opportunities'],
    image: 'https://images.unsplash.com/photo-1576495199011-eb94736d05d6?auto=format&fit=crop&q=80&w=800'
  }, {
    country: 'Australia',
    flag: '🇦🇺',
  ...
  const services = [{
    ...
    description: 'Personalized guidance to choose the right institution based on your profile, budget, and career goals.'
  }, {
    icon: FileText,
    title: 'Application Support',
    description: 'Complete assistance with admission applications, document preparation, and submission tracking.'
  }, {
    icon: BookOpen,
    title: 'SOP & Essay Writing',
    description: 'Professional statement of purpose and essay writing services that highlight your unique story.'
  }, {
    icon: Award,
    title: 'Scholarship Guidance',
    description: 'Identification and application support for scholarships and financial aid opportunities.'
  }, {
    icon: CheckCircle2,
    title: 'Visa Processing',
    description: 'End-to-end student visa application support with high success rates for all destinations.'
  }, {
    icon: Users,
    title: 'Pre-Departure',
    description: 'Comprehensive orientation covering accommodation, travel, and settling into your new country.'
  }] as any[];
  const successStories = [{
    ...
    quote: 'ELPA Travel made my dream of studying in Canada come true. Their SOP assistance was exceptional!'
  }, {
    name: 'Kwame Boateng',
    program: 'Computer Science, University of Manchester',
    country: 'UK',
    image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=kwame2',
    quote: 'The team guided me through every step. I got admission to my dream university with a scholarship!'
  }, {
    name: 'Ama Osei',
    program: 'Public Health, University of Melbourne',
    country: 'Australia',
    image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ama2',
    quote: 'Professional, reliable, and supportive. They turned my study abroad dreams into reality.'
  }] as any[];
  const requirements = ['Valid passport', 'Academic transcripts and certificates', 'English proficiency test (IELTS/TOEFL)', 'Statement of Purpose', 'Letters of recommendation', 'Financial proof documents', 'CV/Resume', 'Passport-sized photographs'];
  return <div className="min-h-screen bg-white pt-24">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            x: 0
              ...
              <p className="text-xl text-blue-100 leading-relaxed mb-10">
                Turn your international education dreams into reality with expert guidance, comprehensive support, and proven success strategies for top universities worldwide.
              </p>
            ...
            delay: 0.2
              ...
              <img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&q=80&w=800" alt="Students" className="rounded-3xl shadow-2xl" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-blue-600 font-bold uppercase tracking-wider text-sm mb-4">Study Destinations</h2>
            <h3 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-6">
              Where Can You Study?
            </h3>
            <p className="text-slate-600 max-w-2xl mx-auto">
              We have partnerships with top universities in the world's most sought-after study destinations.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            {destinations.map((dest, idx) => <motion.div key={idx} initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
            ...
            delay: idx * 0.1
                ...
                <div className="relative h-48 overflow-hidden">
                  <img src={dest.image} alt={dest.country} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                ...
                <div className="p-8">
                  ...
                  <ul className="space-y-3">
                    {dest.highlights.map((highlight, i) => <li key={i} className="flex items-center gap-3 text-slate-700">
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-blue-600 font-bold uppercase tracking-wider text-sm mb-4">Our Services</h2>
            <h3 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-6">
              Complete Study Abroad Support
            </h3>
            <p className="text-slate-600 max-w-2xl mx-auto">
              From university selection to visa approval, we handle every aspect of your study abroad journey.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service, idx) => <motion.div key={idx} initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            once: true
              ...
              <h2 className="text-blue-400 font-bold uppercase tracking-wider text-sm mb-4">Get Prepared</h2>
              <h3 className="text-3xl md:text-5xl font-bold mb-6">
                What You'll Need
              </h3>
              <p className="text-slate-400 mb-8 leading-relaxed">
                We'll guide you through gathering all necessary documents for your application. Here's a general checklist to get you started:
              </p>
            ...
            once: true
              ...
              <ul className="space-y-4">
                {requirements.map((req, idx) => <li key={idx} className="flex items-center gap-3">
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-blue-600 font-bold uppercase tracking-wider text-sm mb-4">Success Stories</h2>
            <h3 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-6">
              From Ghana to Global Universities
            </h3>
            <p className="text-slate-600 max-w-2xl mx-auto">
              Meet some of our successful students who are now thriving in their international universities.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-600 mb-10">
              Book a free consultation with our education experts and start your journey to international education.
            </p>
