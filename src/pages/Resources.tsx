  ...
  const blogPosts = [
    {
      ...
      excerpt:
        'Learn from the most common mistakes that lead to visa rejections and how to strengthen your application.',
      category: 'Visa Tips',
      readTime: '8 min read',
      date: 'March 15, 2024',
      image:
    ...
    },
    {
      ...
      excerpt:
        'Discover the top study destinations offering quality education, work opportunities, and pathways to permanent residency.',
    ...
    },
    {
      ...
      excerpt:
        'Expert tips and strategies for crafting a compelling SOP that gets you accepted into your dream university.',
    ...
    },
    {
      ...
      excerpt:
        'Make the most of your travel budget with these practical money-saving tips for international trips.',
      category: 'Travel',
      readTime: '6 min read',
  ...
  return (
    <div className="min-h-screen bg-white pt-24">
        ...
        <div className="max-w-screen-xl xl:container  mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-blue-100 leading-relaxed mb-8">
              Expert guides, ebooks, and resources to help you navigate visa applications, study
              abroad processes, and international travel with confidence.
            </p>
      ...
      <section className="py-24">
        <div className="containmax-w-screen-xl xl:container er mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              Downloadable comprehensive guides written by travel experts with years of visa
      ...
      <section className="py-24 bg-blue-600">
        <div className="max-w-screen-xl xl:container  mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6">Stay Updated with Travel Tips</h2>
            <p className="text-blue-100 text-lg mb-10">
              Subscribe to our newsletter for exclusive visa tips, study abroad insights, and
